...
// Dernière mise à jour : 11/09/2020 par BRICE BERTHO
...
public class Point
    {
        ...
        {
            double distance = getDistanceBetween(this._latitude, this._longitude, autrePoint._latitude, autrePoint._longitude);
            return distance;
        }
        ...
        {
            double distance = getDistanceBetween(point1._latitude, point1._longitude, point2._latitude, point2._longitude);
            return distance;
        }
